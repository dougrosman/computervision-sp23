...
function windowResized() {
    ...
    cnv.style.setProperty('width', `${scaledWidth}px`, "important");
    cnv.style.setProperty('height', `${scaledHeight}px`, "important");
    

    console.log(cnv.style.width)
}
